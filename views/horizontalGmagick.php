...
<head>
    <meta charset="UTF-8">
    <title>Crop horizontal Gmagick</title>
</head>
<body>
<table>
    <?php
    ...
    foreach ($images as $image) {
        ...
        <tr style="text-align:center">
            ...
            <td><img src="tmp/Gmagick/basic/horizontal/<?php echo $image ?>" border="0"/></td>
            <td><img src="tmp/Gmagick/balanced/horizontal/<?php echo $image ?>" border="0"/></td>
            <td><img src="tmp/Gmagick/Entropy/horizontal/<?php echo $image ?>" border="0"/></td>
        </tr>
        <?php
    }
    ?>
