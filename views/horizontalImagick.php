...
<head>
    <meta charset="UTF-8">
    <title>Crop horizontal Imagick</title>
</head>
<body>
<table>
    <?php
    ...
    foreach ($images as $image) {
        if (strstr($image, '.jpg')) {
            ...
            <tr style="text-align:center">
                ...
                <td><img src="../tmp/Imagick/basic/horizontal/<?php echo $image ?>" border="0"/></td>
                <td><img src="../tmp/Imagick/balanced/horizontal/<?php echo $image ?>" border="0"/></td>
                <td><img src="../tmp/Imagick/Entropy/horizontal/<?php echo $image ?>" border="0"/></td>
            </tr>
            <?php
        }
    }
